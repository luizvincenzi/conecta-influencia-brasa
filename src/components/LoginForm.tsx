  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (userType === "restaurant") {
      toast({
        ...
        description: "Bem-vindo ao seu dashboard de restaurante!",
      });
      navigate("/restaurant-dashboard");
    } else if (userType === "influencer") {
      toast({
        title: "Login bem-sucedido",
        description: "Bem-vindo ao seu dashboard de influenciador!",
      });
      navigate("/influencer-dashboard");
    } else {
      // In a real app, this would navigate based on user type from backend
        ...
        {!userType ? (
          <div className="space-y-4">
            ...
            <Button 
              ...
              className="w-full mb-2 bg-[#0071e3] hover:bg-[#0262c2]"
            >
              Sou Restaurante
            </Button>
            <Button 
              onClick={() => setUserType("influencer")} 
              className="w-full bg-[#0071e3] hover:bg-[#0262c2]"
            >
              Sou Influenciador
            </Button>
          </div>
