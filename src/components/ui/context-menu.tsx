...
>(({ className, inset, children, ...props }, ref) => (
  <ContextMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-md px-2 py-1.5 text-sm outline-none focus:bg-gray-100 focus:text-accent-foreground data-[state=open]:bg-gray-100 data-[state=open]:text-accent-foreground",
      inset && "pl-8",
      className
    )}
    {...props}
